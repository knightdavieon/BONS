...
<div class="modal "  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="pancit">
    <div class="modal-dialog" style="top:40%;" role="document">
        <div class="modal-content">
            <form action="actions/accounts/updatemenu" method="post">
...
<div class="modal "  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="deletemenu<?php echo $i;?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="actions/menu/deletemenu" method="post">
                <div class="modal-header">
                    <h4>Delete Menu</h4>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <input type="hidden" name="accountid" value="<?php echo $rowmenu['item_id']; ?>" />
