...
<body>
  <div class="container-fluid">
    <div class="col-md-12">
      ...
      <div class="tab">
        <button class="tablinks active" onclick="openCity(event, 'London')" >Noodles</button>
      ...
      <div id="London" class="tabcontent active">
        ...
        <?php   $selectmenu = $conn->query("SELECT * FROM menu");
        $i='1';
...
<div id="Paris" class="tabcontent">
  ...
  <div class="row">
    ...
    <div class="col-md-4" style="margin-bottom: 10px;">
      <a href="#tempura" role="button" data-toggle="modal"><img src="resources/images/tempura.png" class="responsive"></a>
    </div>
  </div>
